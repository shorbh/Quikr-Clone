...
ul {
    ...
    <body>
        ...
        ps.setString(1,"Electronics and Appliances");
        ...
        while(rs.next()){
              ...
              fout=new FileOutputStream("C:/Users/Rajender kumar/Desktop/QUIKR/web/images1/ddd"+i+".jpg");  
              fout.write(byteArray); 
              String ref = rs.getString(2);
              %>
              <table style="float:left;">
                  <tr><td>
                          <img src= <%= "images1/ddd"+i+".jpg" %>  style="width:200px;height:200px;" >&nbsp;&nbsp;&nbsp;&nbsp;</td></tr>
